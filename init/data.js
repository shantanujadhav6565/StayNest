...
const sampleListings = [
    ...
    {
        title: "Arctic Mountain Escape",
        description:
            "Experience a peaceful winter escape surrounded by snow-covered mountains and breathtaking landscapes.",
        image: {
            filename: "listingimage",
...

    {
        ...
        description:
            "Stay in a cozy cabin surrounded by snowy landscapes and enjoy the beauty of the Arctic wilderness.",
        image: {
            filename: "listingimage",
